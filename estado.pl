...
% %--------------------------------- - - - - - - - - - -  -  -  -  -   -
% % Extensão do predicado contrato:#IdAd, #IdAda, TipoDeContrato, TipoDeProcedimento, Descrição, Valor, Prazo, Local, Dia, Mês, Ano -> {V,F,D}
% % Conhecimento Perfeito Positivo
...
contrato(3,5,'Aquisicao de servicos','Ajuste direto','bla',4900,75,'Porto',02,02,ano_desconhecido).
excecao(contrato(IdAd,IdAda,TipoDeContrato,TipoDeProcedimento,Descricao,Valor,Prazo,Local,Dia,Mes,Ano)) :- contrato(IdAd,IdAda,TipoDeContrato,TipoDeProcedimento,Descricao,Valor,Prazo,Local,Dia,Mes,ano_desconhecido).

% contrato(3,5,'Aquisicao de servicos','Ajuste direto',descricao_desconhecida,4900,75,'Porto',16,01,2020).
% excecao(contrato(IdAd,IdAda,TipoDeContrato,TipoDeProcedimento,Descricao,Valor,Prazo,Local,Dia,Mes,Ano)) :- contrato(IdAd,IdAda,TipoDeContrato,TipoDeProcedimento,descricao_desconhecida,Valor,Prazo,Local,Dia,Mes,Ano).
