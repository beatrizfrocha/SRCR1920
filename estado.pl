...
contrato(1,1,'Aquisicao de servicos','Ajuste direto','bla',6,prazo_desconhecido,'braga','09-02-2020').
excecao(contrato(IdAd,IdAda,TipoDeContrato,TipoDeProcedimento,Descricao,Valor,Prazo,Local,Data)) :- contrato(IdAd,IdAda,TipoDeContrato,TipoDeProcedimento,Descricao,Valor,prazo_desconhecido,Local,Data).
